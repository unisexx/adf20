...
if (!function_exists('icon_bar')) {
    function icon_bar($socialInfo)
    {
        ...
        foreach ($socialInfo as $item) {
            ...
            if (@$item->provider == 'tinder' && @$item->status == 1) {
                $txt .= '<a rel="nofollow" href="' . @$item->link . '" target="_blank" class="" role="button">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                viewBox="0 0 512.014 512.014" width="22" height="20" style="enable-background:new 0 0 512.014 512.014;" xml:space="preserve">
